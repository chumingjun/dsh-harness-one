...
const LEGACY_CRED_FILES = [
  join(__dirname, '..', 'data', 'credentials.json'),
  join(__dirname, '..', '..', 'dsh-ccpg-orchestrator', 'data', 'credentials.json'),
];
...
function load() {
  for (const file of [credentialFile(), ...LEGACY_CRED_FILES]) {
    try {
