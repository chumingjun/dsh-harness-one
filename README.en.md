...
**A visual AI workflow orchestrator running inside [DeepSeek Harness (dsh)](https://github.com/deepseek-ai/deepseek-harness).** Build multi-agent DAGs with drag-and-drop nodes, watch live execution, recover interrupted runs, and send deliverables to Feishu.
...
- Seven node types: input, agent, QuickJS script, condition, HTTP, output, and note.
...
- Webhook and cron triggers plus optional Feishu document writeback.
